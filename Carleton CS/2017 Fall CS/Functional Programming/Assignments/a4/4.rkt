...
(define (let-def exp) (map cadr (cadr exp)))                    
(define (let? exp) (tagged-list? exp 'let))                                                                                                   
(define (let-param exp) (map car (cadr exp)))                         
...
Please find the relevant changes made to the MCI on lines 156-167 and  22
