...
; 2 functions for adding or removing from score
  ...
  (define (battle Hmove theScore)
    (let ((Cmove (random 3)))
      ...
      (cond
        ((and (equal? Hmove 1) (equal? Cmove 0)) (add1 theScore) )       ; if human wins, add one           
      ...
      (statusPrint theScore Hmove Cmove)      ; print the human, computer moves and the new score that has been set by the result of the battle
