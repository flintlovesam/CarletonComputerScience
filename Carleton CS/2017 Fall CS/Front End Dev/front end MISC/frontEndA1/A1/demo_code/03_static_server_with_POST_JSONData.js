...
//Loading info for sister golden hair
var fs = require('fs'); 
     ...
     var sisterGoldenHair = [];
      ...
      for(let i=0;i<array.length;i++){
       ...
       console.log(arrayOfStrings);
        ...
        for(let k= 0; k<arrayOfStrings.length;k++){
        sisterGoldenHair.push({word: arrayOfStrings[k]} );  // yval is initially set to 50 and increments upwards and x value should be set to the wordlength*perfontpixelsize

          //sisterGoldenHair.push({word: currentLine[k], x: xval + currentLine[k].width() , y:yval } );  // yval is initially set to 50 and increments upwards and x value should be set to the wordlength*perfontpixelsize
   //       xval = currentLine[k].width() + xval;
        }
        
        // console.log(sisterGoldenHair[3]);  

      yval = yval + 50      //increment the line by 50 pixels downwards
    }

//for(r=0; r<sisterGoldenHair.length; r++){
// console.log(sisterGoldenHair[r])};
});
		...
		if(request.method == "POST"){
           ...
           if(dataObj.text == "Sister Golden Hair" ){
            ...
            returnObj.text = 'FOUND: ' + dataObj.text;
             ...
             var returnObj = {};
             returnObj.wordArray = songs["Brown Eyed Girl"];
             returnObj.text = 'FOUND: ' + dataObj.text;
           }
