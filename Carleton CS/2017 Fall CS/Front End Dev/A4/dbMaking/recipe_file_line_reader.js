...
// load the databse we will be writing to 
...
// goes through parameter of database, storing the given topic if string matches
       ...
       if(str === '</directions>'){
        ...
        if (last) {
		   //once done parsing the XML and storing relevant variable we write to the sql db
           console.log("DONE");
