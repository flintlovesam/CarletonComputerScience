...
if(theOutcome == 1){
  ...
  else if(state%2==1){state = state;}  // if state == 1,5,9,13,17,21,25,29, do nothing
  // if not one of those numbers, remove one
}
//unfavorable
...
tsetlin(2,4,calculateStrength(2)); // (one as a starting location)
}
